...
class AffiliatRegisterQuestion extends Component {
	constructor(props){
		super(props);
	...
	submit(e){
		...
		fetch(`${config.base_url}/admin_affiliat_questions_update`,{
			method: 'POST',
			headers: new Headers({
			 ...
			 : null }
				...
				<div className="adminArticle">
					...
					<div className="adminHead">
						<h3>Affiliat Register Question</h3>
						<Row>
							<Col md={8}>
							{this.state.alert ?  
								<div>
...
export default AffiliatRegisterQuestion;